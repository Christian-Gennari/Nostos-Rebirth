...
- Task 8's scroll-reset was dropped: not part of the reported pain, and jumping the scroll position would have been a new behaviour. The chips-row collapse animation was kept.
